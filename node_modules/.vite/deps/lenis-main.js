// node_modules/lenis-main/dist/lenis.mjs
function t(t2, e2) {
...
var h = function() {
  function t2(t3) {
    var e2 = this, o2 = void 0 === t3 ? {} : t3, s3 = o2.direction, h2 = o2.gestureDirection, a = o2.mouseMultiplier, c = o2.smooth, u = o2.wrapper, p = void 0 === u ? window : u, d = o2.content, v = void 0 === d ? document.documentElement : d, m = o2.wheelEventsTarget, f = void 0 === m ? p : m, g = o2.smoothWheel, w = void 0 === g ? null == c || c : g, S = o2.smoothTouch, y = void 0 !== S && S, z = o2.syncTouch, T = void 0 !== z && z, b = o2.duration, E = o2.easing, M = void 0 === E ? function(t4) {
      return Math.min(1, 1.001 - Math.pow(2, -10 * t4));
    } : E, L = o2.lerp, W = void 0 === L ? b ? null : 0.1 : L, R = o2.infinite, O = void 0 !== R && R, _ = o2.orientation, k = void 0 === _ ? null != s3 ? s3 : "vertical" : _, x = o2.gestureOrientation, H = void 0 === x ? null != h2 ? h2 : "vertical" : x, D = o2.touchMultiplier, j = void 0 === D ? 1 : D, X = o2.wheelMultiplier, Y = void 0 === X ? null != a ? a : 1 : X, C = o2.normalizeWheel, P = void 0 !== C && C;
      ...
      if (!l2.ctrlKey) {
        ...
        if (!("vertical" === e2.options.gestureOrientation && 0 === r2 || "horizontal" === e2.options.gestureOrientation && 0 === s4 || h3 && "vertical" === e2.options.gestureOrientation && 0 === e2.scroll && !e2.options.infinite && r2 <= 0 || l2.composedPath().find(function(t5) {
          ...
          if (e2.isStopped || e2.isLocked)
            ...
            p2 && (c2 *= 33), e2.scrollTo(e2.targetScroll + c2, i({ programmatic: false }, u2 && { lerp: p2 ? 0.1 : 0.33 }));
          }
      }
    ...
    } }, this.options.wrapper.addEventListener("scroll", this.onScroll, { passive: false }), this.virtualScroll = new l(f, { touchMultiplier: j, wheelMultiplier: Y, normalizeWheel: P }), this.virtualScroll.on("scroll", this.onVirtualScroll);
  }
  var s2 = t2.prototype;
  return s2.destroy = function() {
    ...
    var i2 = this, n2 = void 0 === e2 ? {} : e2, s3 = n2.offset, r2 = void 0 === s3 ? 0 : s3, l2 = n2.immediate, h2 = void 0 !== l2 && l2, a = n2.lock, c = void 0 !== a && a, u = n2.duration, p = void 0 === u ? this.options.duration : u, d = n2.easing, v = void 0 === d ? this.options.easing : d, m = n2.lerp, f = void 0 === m ? !p && this.options.lerp : m, g = n2.onComplete, w = void 0 === g ? null : g, S = n2.force, y = n2.programmatic, z = void 0 === y || y;
    if (!this.isStopped || void 0 !== S && S) {
      if (["top", "left", "start"].includes(t3))
        ...
        var T, b;
        if ("string" == typeof t3 ? b = document.querySelector(t3) : null != (T = t3) && T.nodeType && (b = t3), b) {
      ...
      if ("number" == typeof t3) {
        if (t3 += r2, this.options.infinite ? z && (this.targetScroll = this.animatedScroll = this.scroll) : t3 = o(0, t3, this.limit), h2)
        ...
        this.animate.fromTo(this.animatedScroll, t3, { duration: p, easing: v, lerp: f, onUpdate: function(t4, e3) {
          var o2 = e3.completed;
          c && (i2.isLocked = true), i2.isScrolling = true, i2.velocity = t4 - i2.animatedScroll, i2.direction = Math.sign(i2.velocity), i2.animatedScroll = t4, i2.setScroll(i2.scroll), z && (i2.targetScroll = t4), o2 && (c && (i2.isLocked = false), requestAnimationFrame(function() {
...
// dep:lenis-main
var lenis_main_default = h;
export {
  lenis_main_default as default
};
//# sourceMappingURL=lenis-main.js.map
